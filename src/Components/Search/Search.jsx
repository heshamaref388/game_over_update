...
export default function Search() {
  ...
  return (
    <>
      <h1 className="border-bottom py-2">
        {" "}
        <i className="fas fa-search me-2 "></i>Find Games
      </h1>
      <div className="col-md-6 mt-3">
        <form className="d-flex" role="search">
          <input
            onChange={search}
            id="search-input"
            className="form-control me-2 bg-transparent border-secondary text-light"
            type="search"
