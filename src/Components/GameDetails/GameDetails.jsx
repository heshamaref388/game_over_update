        ...
        <div className="row">
          <div className="col-md-4 game_image_container">
            ...
            <div className="mt-3 ">
                ...
                <div className="container-fluid">
                  <div className="row">
                    ...
                    <div className="col-3 rounded py-1 likes-item">
                      <div className="like-content text-center">
                        <div className="">
                          <i className="far fa-meh fa-lg text-secondary"></i>
                        </div>
                        <div className="count mb-n2 text-muted">0</div>
                        <span className="title small" style={{ fontSize: 12 }}>
                          MEH
                        </span>
                      </div>
                    </div>
                    <div className="col-3 rounded py-1 likes-item">
                      <div className="like-content text-center">
                        <div className="">
                          <i className="far fa-frown fa-lg text-danger"></i>
                        </div>
                        <div className="count mb-n2 text-muted">0</div>
                        <span
                          className="title p-0"
                    ...
                    <div className="col-3 rounded py-1 likes-item">
                      <div className="like-content text-center">
                        <div className="">
                          <i className="far fa-plus-square fa-lg text-info"></i>
                        </div>
              ...
              <div className="small text-muted mt-3">
                <i className="fas fa-user me-2"></i> Requires 3rd-Party Account
              </div>
            </div>
          </div>
          <div className="col-md-8">
            ...
            {AllGames.platform === "Windows" ? (
              ...
              <h5 className="mt-3 fw-bold">No Running System Requirements</h5>
            )}
            ...
            {screeeen1 ? (
              <Carousel>
                <Carousel.Item interval={1000}>
                  <img className="w-100" src={screeeen1} alt="" />
                </Carousel.Item>
                <Carousel.Item interval={500}>
                  <img className="w-100" src={screeeen2} alt="" />
                </Carousel.Item>
                <Carousel.Item>
                  <img className="w-100" src={screeeen3} alt="" />
                </Carousel.Item>
              </Carousel>
            ) : (
              ""
            ...
            <div className="row mb-5 mt-2">
              ...
              <div className="col-6 col-md-4">
                ...
                <p className="small">
                  {AllGames.platform === "Windows" ? (
                    <i className="fab fa-windows me-1"></i>
                  ) : (
                    <i
                      className="fas fa-window-maximize me-1"
