...
export default function Register() {
  ...
  return (
    <div className="row mt-3 mb-5 mx-lg-5 login-form mx-0">
          ...
          <div className="row justify-content-center align-items-center text-center">
            <form className="my-4" onSubmit={submitRegistrationForm}>
              ...
              {errorList.filter((err) => err.context.label === "email")[0] ? (
                <div className="text-danger mt-1 fs-6 p-1">
                  <small className="m-0">
                    {
                      errorList.filter(
              ...
              {errorList.filter(
                ...
                <div className="text-danger mb-0 mt-1 fs-6 p-1">
                  <small className="m-0">
              ...
              <button type="submit" className="btn btn-gray mt-3 w-100">
                {isLoading ? (
